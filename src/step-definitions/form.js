 ...
 */
Then(/^I see "([^"]*)" select box filled with value "([^"]*)"$/, function (selectBox, value, callback) {
    var _this = this;
...
*/
Then(/^I click on the select box "([^"]*)" to select "([^"]*)"$/, function (selectBox, value, callback) {
    var _this = this;
 ...
 */
When(/^I fill "([^"]*)" field with "([^"]*)"$/, function (fieldName, fieldValue, callback) {
    var _this = this;
 ...
 */
When(/^I fill "([^"]*)" field with "([^"]*)" in iframe "([^"]*)"$/, function (fieldName, fieldValue, iframeElement, callback) {
    var _this = this;
 ...
 */
When(/^I fill "([^"]*)" ckeditor field with "([^"]*)"$/, function (fieldName, fieldValue, callback) {
 ...
 */
Then(/^I can see "([^"]*)" in ckeditor "([^"]*)"$/, function (valueObject, fieldName, callback) {
  var fieldSelector = context.getCurrentPageInstance().getFieldByName(fieldName);
  var _this = this;
 ...
 */
When(/^I fill "([^"]*)" time field with "([^"]*)"$/, function (fieldName, fieldValue, callback) {
    var _this = this;
 ...
 */
When(/^I fill "([^"]*)" datepicker with "([^"]*)"$/, function (fieldName, fieldValue, callback) {
    var _this = this;
 ...
 */
Then(/^I see "([^"]*)" error for "([^"]*)" field$/, function (messageName, fieldName, callback) {
    var _this = this;
 ...
 *  Check format value
 */
Then(/^I see "([^"]*)" select box values match format "([^"]*)"$/, function (selectBox, format, callback) {
    var _this = this;
    var mappedNgModel = context.getCurrentPageInstance().getElementByNgModel(selectBox);
