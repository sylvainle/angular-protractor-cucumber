 ...
 */
Then(/^I see "([^"]*)" in the column "([^"]*)" of the row "([^"]*)" of the table "([^"]*)"$/, function (valueToMatch, columnToSearch, line, table, callback) {
    _this = this;
 ...
 */
When(/^I click on the action "([^"]*)" of the row "([^"]*)" of the table "([^"]*)"$/, function (action, line, table, callback) {
    _this = this;
